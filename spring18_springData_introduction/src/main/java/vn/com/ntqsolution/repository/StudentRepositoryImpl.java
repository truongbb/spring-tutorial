...
public class StudentRepositoryImpl implements StudentRepository {
    ...
    public List<Student> getAllUsingJdbcTemplate() {
        ...
        List<Student> result = jdbcTemplate.query(sql, BeanPropertyRowMapper.newInstance(Student.class));
        /**
    ...
    public List<Student> getAllUsingJdbcTemplateMappingManual() {
        ...
        List<Student> result = jdbcTemplate.query(sql, new StudentMapper()); // map bằng class implement interface của Spring, map bằng cơm các thuộc tính
        return result;
    }
    ...
    public Student getOneById(String id) {
        ...
        List<Student> result = namedParameterJdbcTemplate.query(sql, parameters, BeanPropertyRowMapper.newInstance(Student.class));

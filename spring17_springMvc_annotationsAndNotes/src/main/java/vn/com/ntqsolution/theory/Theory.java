...
public class Theory {
    ...
    /**
     *
     * =============ANNOTATIONS AND NOTE==================
     *
     * Dựa trên code của bài trước, ở bài này sẽ giới thiệu 2 annotation cơ bản khác thuộc data-layer và service-layer,
     *
     * @Reposiroty là một annoation thể hiện rằng đó là bean ở tầng repository, làm nhiệm vụ giao tieeos với DB và lấy ra dữ liệu

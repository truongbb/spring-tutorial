...
public class Theory {
    ...
    /**
     * SPRING MVC VIA JAVA CONFIGURATION
     *
     *
     ...
     * Ở 2 project trước, nó chính là file web.xml + dispatcher-servlet.xml
     ...
     * AbstractAnnotationConfigDispatcherServletInitializer khi khởi động sẽ tạo ra Spring context (đề cập bên trên) bao gòm DispatcherServlet và ContextLoaderListener.
     *
     ...
     *          Nhưng bật annoattion này lên sẽ có 1 số vấn đề ở đây:
     ...
     * Trong trường hợp này URL của API chuẩn sẽ là http://localhost:8080/spring12_spring_Mvc_helloWorld03/home

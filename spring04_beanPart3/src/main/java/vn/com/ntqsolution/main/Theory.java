...
public class Theory {
     ...
     *
     *
     * Một chương trình java bình thường cũng vậy, sẽ có một hàm main chính
     * Khi thực hiện chạy chương trình, hàm main được gọi tới và thực thi.
     * Nó sẽ chạy lần lượt từ trên xuống dưới, công việc khởi tạo đối tượng, gọi hàm, xem xét các thuộc tính con bên trong
     * hay các thuộc tính của cha nó mà nó kế thừa, hoặc các mối quan hệ ràng buộc (dependency) như extends, implements, association, composition, ...
     *
     * Nói tóm lại, toàn bộ chương trình được kết nối lại (wired).
     *
     * Điều tương tự cũng xảy ra khi chúng ta sử dụng Spring, nhưng khác ở chỗ, công việc khởi tạo, đọc các liên kết hay thuộc tính, phương thức
     * là do Spring Container đảm nhiệm. Nó sẽ tạo các instances (Spring gọi là các beans), các mối quan hệ giữa các beans, các sự phụ thuộc được inject
     *

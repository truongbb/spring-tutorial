...
public class StudentRepositoryImpl extends BaseRepository implements StudentRepository {
  ...
  public List<Student> getAllUsingJdbcTemplate() {
     ...
     * bản chất là sử dụng Reflection mà thôi, vì vậy làm thế này sẽ rất ngắn nhưng sẽ ảnh hưởng tới hiệu năng của hệ thống,
  ...
  public List<Student> getAllUsingJdbcTemplateMappingManual() {
    ...
    return getJdbcTemplate().query(sql, new StudentMapper()); // map bằng class implement interface của Spring, map bằng cơm các thuộc tính
  }
